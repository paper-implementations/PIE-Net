...
The dataset pipeline is now fully functional and ready for training your `DecScaleClampedIllumEdgeGuidedNetworkBatchNorm` model on all 4 datasets. The pipeline handles the different ground truth availability and formats automatically, making it easy to train effectively even with partial supervision.
